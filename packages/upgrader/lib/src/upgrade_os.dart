...
extension UpgraderOSCorePlatform on UpgraderOS {
  core.UpgraderPlatform toCorePlatform() {
    return core.UpgraderPlatform(
      currentOSType: switch (currentOSType) {
        UpgraderOSType.android => core.UpgraderOSType.android,
        UpgraderOSType.fuchsia => core.UpgraderOSType.fuchsia,
        UpgraderOSType.ios => core.UpgraderOSType.ios,
        UpgraderOSType.linux => core.UpgraderOSType.linux,
        UpgraderOSType.macos => core.UpgraderOSType.macos,
        UpgraderOSType.web => core.UpgraderOSType.web,
        UpgraderOSType.windows => core.UpgraderOSType.windows,
      },
      current: current,
    );
  }
