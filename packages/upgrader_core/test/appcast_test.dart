...
void main() {
  ...
  test('testing Appcast defaults', () async {
    final appcast = Appcast(
        upgraderPlatform: MockUpgraderPlatform(android: true), osVersion: Version(0, 0, 0));
  ...
  test('testing Appcast file', () async {
    final appcast = TestAppcast(
      upgraderPlatform: MockUpgraderPlatform(android: true),
  ...
  test('Appcast multi Fuchsia', () async {
    final appcast = TestAppcast(
        upgraderPlatform: MockUpgraderPlatform(fuchsia: true), osVersion: Version(0, 0, 0));
    var testFile = await getTestFile(filePath: 'test/testappcastmulti.xml');
    await appcast.parseAppcastItemsFromFile(testFile);
  ...
  test('Appcast multi iOS', () async {
    final appcast = TestAppcast(
        upgraderPlatform: MockUpgraderPlatform(ios: true), osVersion: Version(0, 0, 0));
    var testFile = await getTestFile(filePath: 'test/testappcastmulti.xml');
    await appcast.parseAppcastItemsFromFile(testFile);
  ...
  test('Appcast multi Linux', () async {
    final appcast = TestAppcast(
        upgraderPlatform: MockUpgraderPlatform(linux: true), osVersion: Version(0, 0, 0));
    var testFile = await getTestFile(filePath: 'test/testappcastmulti.xml');
    await appcast.parseAppcastItemsFromFile(testFile);
  ...
  test('Appcast multi macOS', () async {
    final appcast = TestAppcast(
        upgraderPlatform: MockUpgraderPlatform(macos: true), osVersion: Version(0, 0, 0));
    var testFile = await getTestFile(filePath: 'test/testappcastmulti.xml');
    await appcast.parseAppcastItemsFromFile(testFile);
  ...
  test('Appcast multi Windows', () async {
    final appcast = TestAppcast(
        upgraderPlatform: MockUpgraderPlatform(windows: true), osVersion: Version(0, 0, 0));
    var testFile = await getTestFile(filePath: 'test/testappcastmulti.xml');
    await appcast.parseAppcastItemsFromFile(testFile);
  ...
  test('Appcast multi Web', () async {
    final appcast = TestAppcast(
        upgraderPlatform: MockUpgraderPlatform(web: true), osVersion: Version(0, 0, 0));
    var testFile = await getTestFile(filePath: 'test/testappcastmulti.xml');
    await appcast.parseAppcastItemsFromFile(testFile);
